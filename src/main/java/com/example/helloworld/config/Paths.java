...
public sealed interface Paths {
  ...
  static record ApiPaths(String segment, Paths root) implements Paths {

    public MessagesPaths messagesPath() {
      return new MessagesPaths("/messages", Paths.apiPath());
    }

    public static record MessagesPaths(String segment, Paths root) implements Paths {
      ...
      public static record MessagesEndpoint(String segment, Paths root) implements Paths {
